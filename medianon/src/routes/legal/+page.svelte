...
<div class="text-center mt-9">
    ...
    https://www.medianon.org is a free to use website. The source code for it is available on <br>
    ...
    In the email, please provide the offending post's location and what the contents of the post are. <br>
