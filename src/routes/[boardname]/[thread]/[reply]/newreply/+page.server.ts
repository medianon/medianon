...
export const actions: Actions = {
    default: async({request, params})=>{
        ...
        const newlayer = formdata.get("newlayer")!.toString();
        ...
        const replydata: replydatatype = {
            ...
            made: currentime,
            replies: 0,
            parent: parseInt(params.reply),
            layer: parseInt(newlayer),
            report: 5,
            filename: "",
            url: ""
        }
        ...
        if((fileinp.size != 0) && (fileinp.type.startsWith("image"))){
            ...
            const fullpath: string = boardname+"/"+threadid+"/"+newreplystr+"/"+fileinp.name;
        ...
        const newreplyref = doc(db, "boards", boardname, "threads", threadid, "replies", newreplystr);
